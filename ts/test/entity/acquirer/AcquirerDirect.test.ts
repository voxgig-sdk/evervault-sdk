...
describe('AcquirerDirect', async () => {
  ...
  test('direct-load-acquirer', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-acquirer', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['EVERVAULT_TEST_ACQUIRER_ENTID']
