...
(0, node_test_1.describe)('ThreeDsSessionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'three_ds_session.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != three_ds_session_ref01_data.id);
        // LOAD
        const three_ds_session_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(three_ds_session_ref01_data_dt0.id === three_ds_session_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/three_ds_session/ThreeDsSessionTestData.json');
    ...
    let idmap = transform(['three_ds_session01', 'three_ds_session02', 'three_ds_session03', '3ds_session01', '3ds_session02', '3ds_session03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['EVERVAULT_TEST_THREE_DS_SESSION_ENTID'];
...
//# sourceMappingURL=ThreeDsSessionEntity.test.js.map