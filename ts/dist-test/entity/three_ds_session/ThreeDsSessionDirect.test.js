...
(0, node_test_1.describe)('ThreeDsSessionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-three_ds_session', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-three_ds_session', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["3ds_session_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EVERVAULT_TEST_THREE_DS_SESSION_ENTID'];
...
//# sourceMappingURL=ThreeDsSessionDirect.test.js.map