...
(0, node_test_1.describe)('CardArtDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EvervaultSDK({
    ...
    (0, node_test_1.test)('direct-load-card_art', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-card_art', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["network_token_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EvervaultSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.EVERVAULT_APIKEY,
            secret: env.EVERVAULT_SECRET,
        }));
        let idmap = env['EVERVAULT_TEST_CARD_ART_ENTID'];
    ...
    const client = new __1.EvervaultSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CardArtDirect.test.js.map