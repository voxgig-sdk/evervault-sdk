...
(0, node_test_1.describe)('CustomDomainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom_domain', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom_domain', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "relay_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EVERVAULT_TEST_CUSTOM_DOMAIN_ENTID'];
...
//# sourceMappingURL=CustomDomainDirect.test.js.map