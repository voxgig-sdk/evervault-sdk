...
(0, node_test_1.describe)('WebhookEndpointDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-webhook_endpoint', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-webhook_endpoint', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EVERVAULT_TEST_WEBHOOK_ENDPOINT_ENTID'];
...
//# sourceMappingURL=WebhookEndpointDirect.test.js.map