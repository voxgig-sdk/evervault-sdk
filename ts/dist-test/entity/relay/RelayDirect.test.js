...
(0, node_test_1.describe)('RelayDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-relay', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-relay', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EVERVAULT_TEST_RELAY_ENTID'];
...
//# sourceMappingURL=RelayDirect.test.js.map