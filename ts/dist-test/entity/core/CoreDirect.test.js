...
(0, node_test_1.describe)('CoreDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-core', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-core', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["relay01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EVERVAULT_TEST_CORE_ENTID'];
...
//# sourceMappingURL=CoreDirect.test.js.map