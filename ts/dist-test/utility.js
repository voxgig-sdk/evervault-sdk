...
function envOverride(m) {
    if ('TRUE' === process.env.EVERVAULT_TEST_LIVE ||
        'TRUE' === process.env.EVERVAULT_TEST_OVERRIDE) {
    ...
    m.EVERVAULT_TEST_EXPLAIN = process.env.EVERVAULT_TEST_EXPLAIN || m.EVERVAULT_TEST_EXPLAIN;
    return m;
}
