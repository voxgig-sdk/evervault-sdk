...
Object.defineProperty(exports, "EvervaultEntityBase", { enumerable: true, get: function () { return EvervaultEntityBase_1.EvervaultEntityBase; } });
...
class EvervaultSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('EvervaultSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('EvervaultSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('EvervaultSDK: graphql: ' +
...
exports.EvervaultSDK = EvervaultSDK;
const SDK = EvervaultSDK;
exports.SDK = SDK;
//# sourceMappingURL=EvervaultSDK.js.map