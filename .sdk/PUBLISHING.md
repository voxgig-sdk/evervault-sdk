...
|---|---|---|
| `ts/` | @voxgig-sdk/evervault | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/evervault \
      --repository voxgig-sdk/evervault-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/evervault` shows it, and
`npm trust revoke @voxgig-sdk/evervault --id=<id>` removes it.
