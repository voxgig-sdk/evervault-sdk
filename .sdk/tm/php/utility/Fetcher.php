...
// Evervault SDK utility: fetcher

class EvervaultFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EvervaultSDK/1.0)';
    ...
    public static function call(EvervaultContext $ctx, string $fullurl, array $fetchdef): array
    {
