...
// Evervault SDK clienttrack feature
...
class EvervaultClienttrackFeature extends EvervaultBaseFeature
{
    ...
    public function PostConstruct(EvervaultContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Evervault-SDK';
