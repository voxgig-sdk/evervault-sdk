...
class EvervaultTimeoutFeature extends EvervaultBaseFeature
{
    ...
    private function _with_timeout(EvervaultContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EvervaultContext $_ctx, float $ms): void
    {
        $client = $this->client;
