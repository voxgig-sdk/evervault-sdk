...
// Evervault SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class EvervaultTestFeature extends EvervaultBaseFeature
{
    ...
    public function init(EvervaultContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (EvervaultContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = EvervaultParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (EvervaultContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(EvervaultContext $ctx, $op, $args): array
    {
