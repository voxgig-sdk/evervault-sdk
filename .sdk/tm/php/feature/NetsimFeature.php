...
class EvervaultNetsimFeature extends EvervaultBaseFeature
{
    ...
    private function _simulate(EvervaultContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EvervaultContext $ctx, array $applied): void
    {
        $client = $this->client;
