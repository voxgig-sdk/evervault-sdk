...
class EvervaultProxyFeature extends EvervaultBaseFeature
{
    ...
    public function init(EvervaultContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EvervaultContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
