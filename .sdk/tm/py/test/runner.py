...
class EvervaultTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EvervaultTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EvervaultTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EvervaultTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
