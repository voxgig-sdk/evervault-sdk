...
class EvervaultTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EvervaultTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = EvervaultTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = EvervaultTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
