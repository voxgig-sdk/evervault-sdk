...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = EvervaultOmni.make_runner(TEST_JSON_FILE, EvervaultSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : EvervaultOmni.errify(err)
    end
