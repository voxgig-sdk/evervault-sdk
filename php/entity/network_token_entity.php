...
// Evervault SDK NetworkToken entity
...
class NetworkTokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NetworkTokenEntity($this->_client, $opts);
    }

    /**
     * @param NetworkToken|array $args NetworkToken data (assoc-array) to store.
     */
    ...
    /**
     * @return NetworkToken|array The current NetworkToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NetworkToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NetworkToken fields).
     */
    ...
    /**
     * Load a single NetworkToken.
     *
     * @param NetworkTokenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NetworkTokenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NetworkToken|array The loaded NetworkToken as an assoc-array at the
    ...
    /**
     * Create a new NetworkToken.
     *
     * @param NetworkTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NetworkTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NetworkToken|array The created NetworkToken as an assoc-array at the
     *   SDK boundary; throws EvervaultError on failure (item-5 convention).
     */
