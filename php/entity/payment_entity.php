...
class PaymentEntity
{
     ...
     *
     * @param PaymentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PaymentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Payment|array The removed Payment as an assoc-array at the
