...
// Evervault SDK FunctionRun entity
...
class FunctionRunEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FunctionRunEntity($this->_client, $opts);
    }

    /**
     * @param FunctionRun|array $args FunctionRun data (assoc-array) to store.
     */
    ...
    /**
     * @return FunctionRun|array The current FunctionRun data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FunctionRun fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FunctionRun fields).
     */
    ...
    /**
     * Create a new FunctionRun.
     *
     * @param FunctionRunCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FunctionRunCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FunctionRun|array The created FunctionRun as an assoc-array at the
