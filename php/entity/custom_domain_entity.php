...
// Evervault SDK CustomDomain entity
...
class CustomDomainEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomDomainEntity($this->_client, $opts);
    }

    /**
     * @param CustomDomain|array $args CustomDomain data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomDomain|array The current CustomDomain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomDomain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomDomain fields).
     */
    ...
    /**
     * Load a single CustomDomain.
     *
     * @param CustomDomainLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomDomainLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomDomain|array The loaded CustomDomain as an assoc-array at the
     ...
     *
     * @param CustomDomainCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomDomainCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomDomain|array The created CustomDomain as an assoc-array at the
     *   SDK boundary; throws EvervaultError on failure (item-5 convention).
     */
