...
class CoreEntity
{
     ...
     * Create a new Core.
     *
     * @param CoreCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CoreCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Core|array The created Core as an assoc-array at the
    ...
    /**
     * Remove an Core matching the given criteria.
     *
     * @param CoreRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CoreRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Core|array The removed Core as an assoc-array at the
     *   SDK boundary; throws EvervaultError on failure (item-5 convention).
     */
