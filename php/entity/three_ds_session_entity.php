...
// Evervault SDK ThreeDsSession entity
...
class ThreeDsSessionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ThreeDsSessionEntity($this->_client, $opts);
    }

    /**
     * @param ThreeDsSession|array $args ThreeDsSession data (assoc-array) to store.
     */
    ...
    /**
     * @return ThreeDsSession|array The current ThreeDsSession data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ThreeDsSession fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ThreeDsSession fields).
     */
    ...
    /**
     * Load a single ThreeDsSession.
     *
     * @param ThreeDsSessionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ThreeDsSessionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ThreeDsSession|array The loaded ThreeDsSession as an assoc-array at the
    ...
    /**
     * Create a new ThreeDsSession.
     *
     * @param ThreeDsSessionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ThreeDsSessionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ThreeDsSession|array The created ThreeDsSession as an assoc-array at the
     *   SDK boundary; throws EvervaultError on failure (item-5 convention).
     */
