...
// Evervault SDK WebhookEndpoint entity
...
class WebhookEndpointEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WebhookEndpointEntity($this->_client, $opts);
    }

    /**
     * @param WebhookEndpoint|array $args WebhookEndpoint data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhookEndpoint|array The current WebhookEndpoint data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhookEndpoint fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhookEndpoint fields).
     */
    ...
    /**
     * Load a single WebhookEndpoint.
     *
     * @param WebhookEndpointLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebhookEndpointLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhookEndpoint|array The loaded WebhookEndpoint as an assoc-array at the
    ...
    /**
     * Update an existing WebhookEndpoint.
     *
     * @param WebhookEndpointUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhookEndpointUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhookEndpoint|array The updated WebhookEndpoint as an assoc-array at the
     *   SDK boundary; throws EvervaultError on failure (item-5 convention).
     */
