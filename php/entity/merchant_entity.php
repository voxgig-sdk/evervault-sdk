...
class MerchantEntity
{
    ...
    /**
     * Load a single Merchant.
     *
     * @param MerchantLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MerchantLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Merchant|array The loaded Merchant as an assoc-array at the
     ...
     *
     * @param MerchantCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Merchant|array The created Merchant as an assoc-array at the
     *   SDK boundary; throws EvervaultError on failure (item-5 convention).
     */
     ...
     *
     * @param MerchantUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Merchant|array The updated Merchant as an assoc-array at the
     *   SDK boundary; throws EvervaultError on failure (item-5 convention).
     */
