...
// Evervault SDK NetworkTokenCryptogram entity
...
class NetworkTokenCryptogramEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "network_token_cryptogram";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new NetworkTokenCryptogramEntity($this->_client, $opts);
    }

    /**
     * @param NetworkTokenCryptogram|array $args NetworkTokenCryptogram data (assoc-array) to store.
     */
    ...
    /**
     * @return NetworkTokenCryptogram|array The current NetworkTokenCryptogram data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NetworkTokenCryptogram fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NetworkTokenCryptogram fields).
     */
    ...
    /**
     * Create a new NetworkTokenCryptogram.
     *
     * @param NetworkTokenCryptogramCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NetworkTokenCryptogramCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NetworkTokenCryptogram|array The created NetworkTokenCryptogram as an assoc-array at the
