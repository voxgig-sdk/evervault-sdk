...
// Evervault SDK BinLookup entity
...
class BinLookupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BinLookupEntity($this->_client, $opts);
    }

    /**
     * @param BinLookup|array $args BinLookup data (assoc-array) to store.
     */
    ...
    /**
     * @return BinLookup|array The current BinLookup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BinLookup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BinLookup fields).
     */
    ...
    /**
     * Create a new BinLookup.
     *
     * @param BinLookupCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BinLookupCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BinLookup|array The created BinLookup as an assoc-array at the
