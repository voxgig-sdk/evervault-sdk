...
class CardArtEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CardArtEntity($this->_client, $opts);
    }

    /**
     * @param CardArt|array $args CardArt data (assoc-array) to store.
     */
    ...
    /**
     * @return CardArt|array The current CardArt data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CardArt fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CardArt fields).
     */
    ...
    /**
     * Load a single CardArt.
     *
     * @param CardArtLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CardArtLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CardArt|array The loaded CardArt as an assoc-array at the
