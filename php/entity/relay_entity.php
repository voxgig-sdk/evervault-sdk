...
class RelayEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RelayEntity($this->_client, $opts);
    }

    /**
     * @param Relay|array $args Relay data (assoc-array) to store.
     */
    ...
    /**
     * @return Relay|array The current Relay data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Relay fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Relay fields).
     */
     ...
     * Load a single Relay.
     *
     * @param RelayLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RelayLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Relay|array The loaded Relay as an assoc-array at the
     ...
     *
     * @param RelayUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RelayUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Relay|array The updated Relay as an assoc-array at the
     *   SDK boundary; throws EvervaultError on failure (item-5 convention).
     */
