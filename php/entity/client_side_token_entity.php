...
// Evervault SDK ClientSideToken entity
...
class ClientSideTokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ClientSideTokenEntity($this->_client, $opts);
    }

    /**
     * @param ClientSideToken|array $args ClientSideToken data (assoc-array) to store.
     */
    ...
    /**
     * @return ClientSideToken|array The current ClientSideToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ClientSideToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ClientSideToken fields).
     */
    ...
    /**
     * Create a new ClientSideToken.
     *
     * @param ClientSideTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ClientSideTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ClientSideToken|array The created ClientSideToken as an assoc-array at the
