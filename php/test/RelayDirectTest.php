...
class RelayDirectTest extends TestCase
{
    public function test_direct_load_relay(): void
    {
        $setup = relay_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-relay", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function relay_direct_setup($mockres)
{
