...
class CardArtDirectTest extends TestCase
{
    public function test_direct_load_card_art(): void
    {
        $setup = card_art_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-card_art", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
