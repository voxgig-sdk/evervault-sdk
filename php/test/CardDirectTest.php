...
{
    public function test_direct_load_card(): void
    {
        $setup = card_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-card", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
