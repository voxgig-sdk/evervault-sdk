...
// Evervault SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EvervaultSDK::test)
...
{
    private const SDK_CLASS = 'EvervaultSDK';
    ...
    private const SDK_BASE = 'evervault_sdk';
