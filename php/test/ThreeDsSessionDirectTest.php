...
class ThreeDsSessionDirectTest extends TestCase
{
    public function test_direct_load_three_ds_session(): void
    {
        $setup = three_ds_session_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-three_ds_session", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
