...
class RelayEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EVERVAULT_TEST_RELAY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $relay_ref01_data = null;
        if (count($relay_ref01_data_raw) > 0) {
