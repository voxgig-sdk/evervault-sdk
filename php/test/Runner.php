...
class EvervaultTestRunner
{
    ...
    {
        $live = self::getenv('EVERVAULT_TEST_LIVE');
        $override = self::getenv('EVERVAULT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('EVERVAULT_TEST_EXPLAIN');
...
class_alias('EvervaultTestRunner', 'Runner');
class_alias('EvervaultHelpers', 'Helpers');
