...
class AcquirerDirectTest extends TestCase
{
    public function test_direct_load_acquirer(): void
    {
        $setup = acquirer_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-acquirer", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
