...
class CustomDomainDirectTest extends TestCase
{
    public function test_direct_load_custom_domain(): void
    {
        $setup = custom_domain_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-custom_domain", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
