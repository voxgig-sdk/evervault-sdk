...
// Evervault SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EvervaultTransformResponse
{
    public static function call(EvervaultContext $ctx): mixed
    {
        ...
        $transform = EvervaultHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
