...
class EvervaultGraphql
{
    ...
    // equivalent.
    public static function body(EvervaultContext $ctx): mixed
    {
    ...
    public static function errors(EvervaultContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
