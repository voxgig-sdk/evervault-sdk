...
// Evervault SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EvervaultMakeRequest
{
    public static function call(EvervaultContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EvervaultResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EvervaultResponse($fetched);
        } else {
