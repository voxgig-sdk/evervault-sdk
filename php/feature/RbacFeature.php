...
class EvervaultRbacFeature extends EvervaultBaseFeature
{
    ...
    private function _required(EvervaultContext $ctx): ?string
    {
    ...
    private function _reject(EvervaultContext $ctx, string $required): void
    {
    ...
    private function _track(EvervaultContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
