...
// Evervault SDK streaming feature
...
class EvervaultStreamingFeature extends EvervaultBaseFeature
{
    ...
    private function _iterate(EvervaultResult $result): \Generator
    {
    ...
    private function _streamable(EvervaultContext $ctx): bool
    {
