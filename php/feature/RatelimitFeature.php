...
// Evervault SDK ratelimit feature
...
class EvervaultRatelimitFeature extends EvervaultBaseFeature
{
    ...
    private function _acquire(EvervaultContext $ctx): void
    {
    ...
    private function _track(EvervaultContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
