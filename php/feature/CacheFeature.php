...
class EvervaultCacheFeature extends EvervaultBaseFeature
{
    ...
    private function _through(EvervaultContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
