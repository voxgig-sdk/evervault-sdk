...
class NetworkTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NetworkTokenEntity(self._client, opts)
    ...
    def data_get(self) -> NetworkToken:
    ...
    def match_get(self) -> NetworkToken:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NetworkToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NetworkToken().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: NetworkTokenCreateData, ctrl=None) -> NetworkToken:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
