...
class ClientSideTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ClientSideTokenEntity(self._client, opts)
    ...
    def data_get(self) -> ClientSideToken:
    ...
    def match_get(self) -> ClientSideToken:
    ...
    def create(self, reqdata: ClientSideTokenCreateData, ctrl=None) -> ClientSideToken:
        utility = self._utility
