...
class WebhookEndpointEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhookEndpointEntity(self._client, opts)
    ...
    def data_get(self) -> WebhookEndpoint:
    ...
    def match_get(self) -> WebhookEndpoint:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WebhookEndpoint:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WebhookEndpoint().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: WebhookEndpointUpdateData, ctrl=None) -> WebhookEndpoint:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
