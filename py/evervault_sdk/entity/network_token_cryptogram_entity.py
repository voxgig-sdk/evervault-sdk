...
class NetworkTokenCryptogramEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NetworkTokenCryptogramEntity(self._client, opts)
    ...
    def data_get(self) -> NetworkTokenCryptogram:
    ...
    def match_get(self) -> NetworkTokenCryptogram:
    ...
    def create(self, reqdata: NetworkTokenCryptogramCreateData, ctrl=None) -> NetworkTokenCryptogram:
        utility = self._utility
