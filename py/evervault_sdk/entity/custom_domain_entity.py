...
class CustomDomainEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomDomainEntity(self._client, opts)
    ...
    def data_get(self) -> CustomDomain:
    ...
    def match_get(self) -> CustomDomain:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CustomDomain:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CustomDomain().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CustomDomainCreateData, ctrl=None) -> CustomDomain:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
