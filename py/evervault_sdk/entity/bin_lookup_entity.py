...
class BinLookupEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BinLookupEntity(self._client, opts)
    ...
    def create(self, reqdata: BinLookupCreateData, ctrl=None) -> BinLookup:
        utility = self._utility
