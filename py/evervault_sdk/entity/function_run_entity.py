...
class FunctionRunEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FunctionRunEntity(self._client, opts)
    ...
    def match_get(self) -> FunctionRun:
    ...
    def create(self, reqdata: FunctionRunCreateData, ctrl=None) -> FunctionRun:
        utility = self._utility
