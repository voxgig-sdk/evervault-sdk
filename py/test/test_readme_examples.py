# Evervault SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EvervaultSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EvervaultSDK(...) and EvervaultSDK.test(...) become
#      EvervaultSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "evervault_sdk"
_SDK_CLASS = "EvervaultSDK"
