...
type Args struct {
	Entity string         `json:"entity" jsonschema:"acquirer | bin_lookup | card | card_art | client_side_token | core | custom_domain | function_run | merchant | network_token | network_token_cryptogram | payment | relay | three_ds_session | webhook | webhook_endpoint"`
...
func registerTools(server *mcp.Server, client *sdk.EvervaultSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "evervault_list",
		Description: "List records from Evervault. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "evervault_load",
		Description: "Load a single record from Evervault. " +
...
func runOp(client *sdk.EvervaultSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
