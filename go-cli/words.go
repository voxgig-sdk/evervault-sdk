...
func registerSDKWords(r *eng.Registry, client *sdk.EvervaultSDK) {
...
func runOp(client *sdk.EvervaultSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
