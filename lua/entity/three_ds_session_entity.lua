...
local ThreeDsSessionEntity = {}
ThreeDsSessionEntity.__index = ThreeDsSessionEntity


function ThreeDsSessionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ThreeDsSessionEntity)
  self._name = "three_ds_session"
  self._client = client
...
function ThreeDsSessionEntity:get_name()
  return self._name
end


function ThreeDsSessionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ThreeDsSessionEntity.new(self._client, opts)
end
...
function ThreeDsSessionEntity:mark_deleted()
  self._deleted = true
end


function ThreeDsSessionEntity:deleted()
  return true == self._deleted
end


function ThreeDsSessionEntity:data_set(args)
  if args ~= nil then
...
function ThreeDsSessionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ThreeDsSessionEntity:match_set(args)
  if args ~= nil then
...
function ThreeDsSessionEntity:match_get()
...
function ThreeDsSessionEntity:stream(action, args, callopts)
...
---@param reqmatch ThreeDsSessionLoadMatch
---@param ctrl? table
---@return ThreeDsSession
---@return string? err
function ThreeDsSessionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ThreeDsSessionCreateData
---@param ctrl? table
---@return ThreeDsSession
---@return string? err
function ThreeDsSessionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ThreeDsSessionEntity:_run_op(ctx, post_done)
  local utility = self._utility
