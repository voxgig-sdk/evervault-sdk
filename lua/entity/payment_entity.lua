...
function PaymentEntity:mark_deleted()
  self._deleted = true
end


function PaymentEntity:deleted()
...
function PaymentEntity:stream(action, args, callopts)
...
---@param reqmatch PaymentListMatch
---@param ctrl? table
---@return Payment[]
---@return string? err
function PaymentEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PaymentRemoveMatch
---@param ctrl? table
---@return Payment
---@return string? err
function PaymentEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
