...
---@param reqmatch MerchantLoadMatch
---@param ctrl? table
---@return Merchant
---@return string? err
function MerchantEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata MerchantCreateData
---@param ctrl? table
---@return Merchant
---@return string? err
function MerchantEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata MerchantUpdateData
---@param ctrl? table
---@return Merchant
---@return string? err
function MerchantEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
