...
local NetworkTokenCryptogramEntity = {}
NetworkTokenCryptogramEntity.__index = NetworkTokenCryptogramEntity


function NetworkTokenCryptogramEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NetworkTokenCryptogramEntity)
  self._name = "network_token_cryptogram"
  self._client = client
...
function NetworkTokenCryptogramEntity:get_name()
  return self._name
end


function NetworkTokenCryptogramEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NetworkTokenCryptogramEntity.new(self._client, opts)
end
...
function NetworkTokenCryptogramEntity:mark_deleted()
  self._deleted = true
end


function NetworkTokenCryptogramEntity:deleted()
  return true == self._deleted
end


function NetworkTokenCryptogramEntity:data_set(args)
  if args ~= nil then
...
function NetworkTokenCryptogramEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NetworkTokenCryptogramEntity:match_set(args)
  if args ~= nil then
...
function NetworkTokenCryptogramEntity:match_get()
...
function NetworkTokenCryptogramEntity:stream(action, args, callopts)
...
---@param reqdata NetworkTokenCryptogramCreateData
---@param ctrl? table
---@return NetworkTokenCryptogram
---@return string? err
function NetworkTokenCryptogramEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function NetworkTokenCryptogramEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return NetworkTokenCryptogramEntity
