...
local ClientSideTokenEntity = {}
ClientSideTokenEntity.__index = ClientSideTokenEntity


function ClientSideTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ClientSideTokenEntity)
  self._name = "client_side_token"
  self._client = client
...
function ClientSideTokenEntity:get_name()
  return self._name
end


function ClientSideTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ClientSideTokenEntity.new(self._client, opts)
end
...
function ClientSideTokenEntity:mark_deleted()
  self._deleted = true
end


function ClientSideTokenEntity:deleted()
  return true == self._deleted
end


function ClientSideTokenEntity:data_set(args)
  if args ~= nil then
...
function ClientSideTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ClientSideTokenEntity:match_set(args)
  if args ~= nil then
...
function ClientSideTokenEntity:match_get()
...
function ClientSideTokenEntity:stream(action, args, callopts)
...
---@param reqdata ClientSideTokenCreateData
---@param ctrl? table
---@return ClientSideToken
---@return string? err
function ClientSideTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ClientSideTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
