...
describe("CardArtDirect", function()
  it("should direct-load-card_art", function()
    local setup = card_art_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-card_art", setup.live and "live" or "unit")
...
function card_art_direct_setup(mockres)
