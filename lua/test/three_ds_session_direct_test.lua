...
describe("ThreeDsSessionDirect", function()
  it("should direct-load-three_ds_session", function()
    local setup = three_ds_session_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-three_ds_session", setup.live and "live" or "unit")
...
function three_ds_session_direct_setup(mockres)
