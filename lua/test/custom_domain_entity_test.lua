...
describe("CustomDomainEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set EVERVAULT_TEST_CUSTOM_DOMAIN_ENTID JSON to run live")
      return
    end
    ...
    -- LOAD
    local custom_domain_ref01_match_dt0 = {
...
function custom_domain_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("EVERVAULT_TEST_CUSTOM_DOMAIN_ENTID")
