...
describe("CustomDomainDirect", function()
  it("should direct-load-custom_domain", function()
    local setup = custom_domain_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-custom_domain", setup.live and "live" or "unit")
...
function custom_domain_direct_setup(mockres)
