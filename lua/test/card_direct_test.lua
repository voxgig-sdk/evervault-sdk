...
describe("CardDirect", function()
  it("should direct-load-card", function()
    local setup = card_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-card", setup.live and "live" or "unit")
