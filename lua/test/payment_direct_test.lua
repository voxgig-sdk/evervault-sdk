...
describe("PaymentDirect", function()
  it("should direct-list-payment", function()
    local setup = payment_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-payment", setup.live and "live" or "unit")
...
function payment_direct_setup(mockres)
