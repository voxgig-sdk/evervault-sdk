...
describe("NetworkTokenDirect", function()
  it("should direct-load-network_token", function()
    local setup = network_token_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-network_token", setup.live and "live" or "unit")
...
function network_token_direct_setup(mockres)
