...
describe("AcquirerEntity", function()
  it("should create instance", function()
    ...
    local ent = testsdk:Acquirer(nil)
  ...
  it("should run basic flow", function()
    ...
    -- CREATE
    local acquirer_ref01_ent = client:Acquirer(nil)
    local acquirer_ref01_data = helpers.to_map(vs.getprop(
    ...
    local acquirer_ref01_markdef_up0_name = "description"
    local acquirer_ref01_markdef_up0_value = "Mark01-acquirer_ref01_" .. tostring(setup.now)
    ...
    -- LOAD
    local acquirer_ref01_match_dt0 = {
      id = acquirer_ref01_data["id"],
    }
...
function acquirer_basic_setup(extra)
  ...
  local entity_data_file = _test_dir .. "../../.sdk/test/entity/acquirer/AcquirerTestData.json"
  local f = io.open(entity_data_file, "r")
  if f == nil then
    error("failed to read acquirer test data: " .. entity_data_file)
  end
