...
describe("AcquirerDirect", function()
  it("should direct-load-acquirer", function()
    local setup = acquirer_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-acquirer", setup.live and "live" or "unit")
...
function acquirer_direct_setup(mockres)
