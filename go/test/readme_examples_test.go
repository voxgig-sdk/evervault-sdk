...
const testSeed = `map[string]any{"entity": map[string]any{"acquirer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bin_lookup": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card_art": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "client_side_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "core": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "function_run": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "network_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "network_token_cryptogram": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "relay": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "three_ds_session": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook_endpoint": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
