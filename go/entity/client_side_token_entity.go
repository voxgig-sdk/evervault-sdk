...
type ClientSideTokenEntity struct {
	name    string
...
func NewClientSideTokenEntity(client *core.EvervaultSDK, entopts map[string]any) *ClientSideTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClientSideTokenEntity) GetName() string { return e.name }
...
func (e *ClientSideTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClientSideTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *ClientSideTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClientSideTokenEntity(e.client, opts)
}

func (e *ClientSideTokenEntity) Data(args ...any) any {
...
func (e *ClientSideTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ClientSideToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClientSideTokenEntity) DataTyped(data ...ClientSideToken) ClientSideToken {
	if len(data) > 0 {
		return typedFrom[ClientSideToken](e.Data(asMap(data[0])))
	}
	return typedFrom[ClientSideToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ClientSideToken (all fields
// optional at the wire level).
func (e *ClientSideTokenEntity) MatchTyped(match ...ClientSideToken) ClientSideToken {
	if len(match) > 0 {
		return typedFrom[ClientSideToken](e.Match(asMap(match[0])))
	}
	return typedFrom[ClientSideToken](e.Match())
}
...
func (e *ClientSideTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClientSideTokenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ClientSideTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ClientSideTokenEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClientSideTokenCreateData and returns an ClientSideToken. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ClientSideTokenEntity) CreateTyped(reqdata ClientSideTokenCreateData, ctrl map[string]any) (ClientSideToken, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ClientSideToken{}, err
	}
	return typedFrom[ClientSideToken](res), nil
}



func (e *ClientSideTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClientSideTokenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClientSideTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
