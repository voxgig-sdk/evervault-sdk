...
func NewRelayEntity(client *core.EvervaultSDK, entopts map[string]any) *RelayEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RelayEntity) Deleted() bool {
	return e.deleted
}


func (e *RelayEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRelayEntity(e.client, opts)
}

func (e *RelayEntity) Data(args ...any) any {
...
func (e *RelayEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Relay; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RelayEntity) DataTyped(data ...Relay) Relay {
	if len(data) > 0 {
		return typedFrom[Relay](e.Data(asMap(data[0])))
	}
	return typedFrom[Relay](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Relay (all fields
// optional at the wire level).
func (e *RelayEntity) MatchTyped(match ...Relay) Relay {
	if len(match) > 0 {
		return typedFrom[Relay](e.Match(asMap(match[0])))
	}
...
func (e *RelayEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RelayLoadMatch and returns an Relay. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RelayEntity) LoadTyped(reqmatch RelayLoadMatch, ctrl map[string]any) (Relay, error) {
...
func (e *RelayEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// RelayUpdateData and returns an Relay. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *RelayEntity) UpdateTyped(reqdata RelayUpdateData, ctrl map[string]any) (Relay, error) {
