...
func NewCardArtEntity(client *core.EvervaultSDK, entopts map[string]any) *CardArtEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardArtEntity) GetName() string { return e.name }
...
func (e *CardArtEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CardArtEntity) Deleted() bool {
	return e.deleted
}


func (e *CardArtEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCardArtEntity(e.client, opts)
}

func (e *CardArtEntity) Data(args ...any) any {
...
func (e *CardArtEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CardArt; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CardArtEntity) DataTyped(data ...CardArt) CardArt {
	if len(data) > 0 {
		return typedFrom[CardArt](e.Data(asMap(data[0])))
	}
	return typedFrom[CardArt](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CardArt (all fields
// optional at the wire level).
func (e *CardArtEntity) MatchTyped(match ...CardArt) CardArt {
	if len(match) > 0 {
		return typedFrom[CardArt](e.Match(asMap(match[0])))
	}
	return typedFrom[CardArt](e.Match())
}
...
func (e *CardArtEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CardArtEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CardArtLoadMatch and returns an CardArt. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CardArtEntity) LoadTyped(reqmatch CardArtLoadMatch, ctrl map[string]any) (CardArt, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CardArt{}, err
	}
	return typedFrom[CardArt](res), nil
}



func (e *CardArtEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CardArtEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CardArtEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CardArtEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CardArtEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
