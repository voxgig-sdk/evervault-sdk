...
func NewCardEntity(client *core.EvervaultSDK, entopts map[string]any) *CardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *CardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
