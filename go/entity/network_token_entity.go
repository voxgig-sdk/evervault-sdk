...
type NetworkTokenEntity struct {
	name    string
...
func NewNetworkTokenEntity(client *core.EvervaultSDK, entopts map[string]any) *NetworkTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NetworkTokenEntity) GetName() string { return e.name }
...
func (e *NetworkTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NetworkTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *NetworkTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNetworkTokenEntity(e.client, opts)
}

func (e *NetworkTokenEntity) Data(args ...any) any {
...
func (e *NetworkTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NetworkToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NetworkTokenEntity) DataTyped(data ...NetworkToken) NetworkToken {
	if len(data) > 0 {
		return typedFrom[NetworkToken](e.Data(asMap(data[0])))
	}
	return typedFrom[NetworkToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NetworkToken (all fields
// optional at the wire level).
func (e *NetworkTokenEntity) MatchTyped(match ...NetworkToken) NetworkToken {
	if len(match) > 0 {
		return typedFrom[NetworkToken](e.Match(asMap(match[0])))
	}
	return typedFrom[NetworkToken](e.Match())
}
...
func (e *NetworkTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NetworkTokenEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NetworkTokenLoadMatch and returns an NetworkToken. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NetworkTokenEntity) LoadTyped(reqmatch NetworkTokenLoadMatch, ctrl map[string]any) (NetworkToken, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NetworkToken{}, err
	}
	return typedFrom[NetworkToken](res), nil
}



func (e *NetworkTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *NetworkTokenEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// NetworkTokenCreateData and returns an NetworkToken. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *NetworkTokenEntity) CreateTyped(reqdata NetworkTokenCreateData, ctrl map[string]any) (NetworkToken, error) {
...
func (e *NetworkTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NetworkTokenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NetworkTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
