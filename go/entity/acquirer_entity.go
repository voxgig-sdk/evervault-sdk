...
func NewAcquirerEntity(client *core.EvervaultSDK, entopts map[string]any) *AcquirerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AcquirerEntity) GetName() string { return e.name }
...
func (e *AcquirerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AcquirerEntity) Deleted() bool {
	return e.deleted
}


func (e *AcquirerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAcquirerEntity(e.client, opts)
}

func (e *AcquirerEntity) Data(args ...any) any {
...
func (e *AcquirerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Acquirer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AcquirerEntity) DataTyped(data ...Acquirer) Acquirer {
	if len(data) > 0 {
		return typedFrom[Acquirer](e.Data(asMap(data[0])))
	}
	return typedFrom[Acquirer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Acquirer (all fields
// optional at the wire level).
func (e *AcquirerEntity) MatchTyped(match ...Acquirer) Acquirer {
	if len(match) > 0 {
		return typedFrom[Acquirer](e.Match(asMap(match[0])))
	}
	return typedFrom[Acquirer](e.Match())
}
...
func (e *AcquirerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AcquirerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AcquirerLoadMatch and returns an Acquirer. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AcquirerEntity) LoadTyped(reqmatch AcquirerLoadMatch, ctrl map[string]any) (Acquirer, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Acquirer{}, err
	}
	return typedFrom[Acquirer](res), nil
}



func (e *AcquirerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AcquirerEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AcquirerCreateData and returns an Acquirer. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AcquirerEntity) CreateTyped(reqdata AcquirerCreateData, ctrl map[string]any) (Acquirer, error) {
...
func (e *AcquirerEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// AcquirerUpdateData and returns an Acquirer. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *AcquirerEntity) UpdateTyped(reqdata AcquirerUpdateData, ctrl map[string]any) (Acquirer, error) {
...
func (e *AcquirerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AcquirerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
