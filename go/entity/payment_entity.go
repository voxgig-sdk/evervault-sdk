...
func NewPaymentEntity(client *core.EvervaultSDK, entopts map[string]any) *PaymentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaymentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaymentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PaymentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaymentListMatch and returns []Payment. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PaymentEntity) ListTyped(reqmatch PaymentListMatch, ctrl map[string]any) ([]Payment, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Payment](res), nil
}



func (e *PaymentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PaymentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *PaymentEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PaymentRemoveMatch and returns an Payment. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PaymentEntity) RemoveTyped(reqmatch PaymentRemoveMatch, ctrl map[string]any) (Payment, error) {
