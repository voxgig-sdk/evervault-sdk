...
type CustomDomainEntity struct {
	name    string
...
func NewCustomDomainEntity(client *core.EvervaultSDK, entopts map[string]any) *CustomDomainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CustomDomainEntity) GetName() string { return e.name }
...
func (e *CustomDomainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CustomDomainEntity) Deleted() bool {
	return e.deleted
}


func (e *CustomDomainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCustomDomainEntity(e.client, opts)
}

func (e *CustomDomainEntity) Data(args ...any) any {
...
func (e *CustomDomainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CustomDomain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CustomDomainEntity) DataTyped(data ...CustomDomain) CustomDomain {
	if len(data) > 0 {
		return typedFrom[CustomDomain](e.Data(asMap(data[0])))
	}
	return typedFrom[CustomDomain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CustomDomain (all fields
// optional at the wire level).
func (e *CustomDomainEntity) MatchTyped(match ...CustomDomain) CustomDomain {
	if len(match) > 0 {
		return typedFrom[CustomDomain](e.Match(asMap(match[0])))
	}
	return typedFrom[CustomDomain](e.Match())
}
...
func (e *CustomDomainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CustomDomainEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CustomDomainLoadMatch and returns an CustomDomain. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CustomDomainEntity) LoadTyped(reqmatch CustomDomainLoadMatch, ctrl map[string]any) (CustomDomain, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CustomDomain{}, err
	}
	return typedFrom[CustomDomain](res), nil
}



func (e *CustomDomainEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CustomDomainEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CustomDomainCreateData and returns an CustomDomain. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CustomDomainEntity) CreateTyped(reqdata CustomDomainCreateData, ctrl map[string]any) (CustomDomain, error) {
...
func (e *CustomDomainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CustomDomainEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CustomDomainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
