...
func NewWebhookEndpointEntity(client *core.EvervaultSDK, entopts map[string]any) *WebhookEndpointEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WebhookEndpointEntity) GetName() string { return e.name }
...
func (e *WebhookEndpointEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WebhookEndpointEntity) Deleted() bool {
	return e.deleted
}


func (e *WebhookEndpointEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWebhookEndpointEntity(e.client, opts)
}

func (e *WebhookEndpointEntity) Data(args ...any) any {
...
func (e *WebhookEndpointEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WebhookEndpoint; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WebhookEndpointEntity) DataTyped(data ...WebhookEndpoint) WebhookEndpoint {
	if len(data) > 0 {
		return typedFrom[WebhookEndpoint](e.Data(asMap(data[0])))
	}
	return typedFrom[WebhookEndpoint](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WebhookEndpoint (all fields
// optional at the wire level).
func (e *WebhookEndpointEntity) MatchTyped(match ...WebhookEndpoint) WebhookEndpoint {
	if len(match) > 0 {
		return typedFrom[WebhookEndpoint](e.Match(asMap(match[0])))
	}
	return typedFrom[WebhookEndpoint](e.Match())
}
...
func (e *WebhookEndpointEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WebhookEndpointEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WebhookEndpointLoadMatch and returns an WebhookEndpoint. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WebhookEndpointEntity) LoadTyped(reqmatch WebhookEndpointLoadMatch, ctrl map[string]any) (WebhookEndpoint, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WebhookEndpoint{}, err
	}
	return typedFrom[WebhookEndpoint](res), nil
}



func (e *WebhookEndpointEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WebhookEndpointEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *WebhookEndpointEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// WebhookEndpointUpdateData and returns an WebhookEndpoint. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *WebhookEndpointEntity) UpdateTyped(reqdata WebhookEndpointUpdateData, ctrl map[string]any) (WebhookEndpoint, error) {
...
func (e *WebhookEndpointEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WebhookEndpointEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
