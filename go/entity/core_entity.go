...
func NewCoreEntity(client *core.EvervaultSDK, entopts map[string]any) *CoreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CoreEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *CoreEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CoreCreateData and returns an Core. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CoreEntity) CreateTyped(reqdata CoreCreateData, ctrl map[string]any) (Core, error) {
...
func (e *CoreEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CoreRemoveMatch and returns an Core. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CoreEntity) RemoveTyped(reqmatch CoreRemoveMatch, ctrl map[string]any) (Core, error) {
