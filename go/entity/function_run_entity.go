...
func NewFunctionRunEntity(client *core.EvervaultSDK, entopts map[string]any) *FunctionRunEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FunctionRunEntity) GetName() string { return e.name }
...
func (e *FunctionRunEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FunctionRunEntity) Deleted() bool {
	return e.deleted
}


func (e *FunctionRunEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFunctionRunEntity(e.client, opts)
}

func (e *FunctionRunEntity) Data(args ...any) any {
...
func (e *FunctionRunEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FunctionRun; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FunctionRunEntity) DataTyped(data ...FunctionRun) FunctionRun {
	if len(data) > 0 {
		return typedFrom[FunctionRun](e.Data(asMap(data[0])))
	}
	return typedFrom[FunctionRun](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FunctionRun (all fields
// optional at the wire level).
func (e *FunctionRunEntity) MatchTyped(match ...FunctionRun) FunctionRun {
	if len(match) > 0 {
		return typedFrom[FunctionRun](e.Match(asMap(match[0])))
	}
	return typedFrom[FunctionRun](e.Match())
}
...
func (e *FunctionRunEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FunctionRunEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FunctionRunEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *FunctionRunEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FunctionRunCreateData and returns an FunctionRun. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FunctionRunEntity) CreateTyped(reqdata FunctionRunCreateData, ctrl map[string]any) (FunctionRun, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return FunctionRun{}, err
	}
	return typedFrom[FunctionRun](res), nil
}



func (e *FunctionRunEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FunctionRunEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FunctionRunEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
