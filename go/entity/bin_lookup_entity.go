...
func NewBinLookupEntity(client *core.EvervaultSDK, entopts map[string]any) *BinLookupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BinLookupEntity) GetName() string { return e.name }
...
func (e *BinLookupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BinLookupEntity) Deleted() bool {
	return e.deleted
}


func (e *BinLookupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBinLookupEntity(e.client, opts)
}

func (e *BinLookupEntity) Data(args ...any) any {
...
func (e *BinLookupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BinLookup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BinLookupEntity) DataTyped(data ...BinLookup) BinLookup {
	if len(data) > 0 {
		return typedFrom[BinLookup](e.Data(asMap(data[0])))
	}
	return typedFrom[BinLookup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BinLookup (all fields
// optional at the wire level).
func (e *BinLookupEntity) MatchTyped(match ...BinLookup) BinLookup {
	if len(match) > 0 {
		return typedFrom[BinLookup](e.Match(asMap(match[0])))
	}
	return typedFrom[BinLookup](e.Match())
}
...
func (e *BinLookupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BinLookupEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BinLookupEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BinLookupEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BinLookupCreateData and returns an BinLookup. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BinLookupEntity) CreateTyped(reqdata BinLookupCreateData, ctrl map[string]any) (BinLookup, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BinLookup{}, err
	}
	return typedFrom[BinLookup](res), nil
}



func (e *BinLookupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BinLookupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BinLookupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
