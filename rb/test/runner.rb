...
module EvervaultTestRunner
  ...
  def self.env_override(m)
    live = getenv("EVERVAULT_TEST_LIVE")
    override = getenv("EVERVAULT_TEST_OVERRIDE")
    ...
    explain = getenv("EVERVAULT_TEST_EXPLAIN")
    m["EVERVAULT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = EvervaultTestRunner
Helpers = EvervaultHelpers
Vs = VoxgigStruct
