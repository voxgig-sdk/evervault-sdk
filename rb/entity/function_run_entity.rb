...
class FunctionRunEntity
  ...
  def make
    opts = @_entopts.dup
    FunctionRunEntity.new(@_client, opts)
  end
  ...
  # @return [FunctionRun, Hash] the current FunctionRun data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FunctionRun fields)
  def match_get
  ...
  #
  # @param reqdata [FunctionRunCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [FunctionRun, Hash] the created FunctionRun; raises EvervaultError on failure
