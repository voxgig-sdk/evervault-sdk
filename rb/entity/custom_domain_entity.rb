...
class CustomDomainEntity
  ...
  def make
    opts = @_entopts.dup
    CustomDomainEntity.new(@_client, opts)
  end
  ...
  # @return [CustomDomain, Hash] the current CustomDomain data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CustomDomain fields)
  def match_get
  ...
  #
  # @param reqmatch [CustomDomainLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CustomDomain.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomDomain, Hash] the loaded CustomDomain; raises EvervaultError on failure
  ...
  #
  # @param reqdata [CustomDomainCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomDomain, Hash] the created CustomDomain; raises EvervaultError on failure
