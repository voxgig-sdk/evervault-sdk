...
class PaymentEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentEntity.new(@_client, opts)
  end
  ...
  # @return [Payment, Hash] the current Payment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Payment fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentListMatch, Hash, nil] match filter (any subset of
  #   Payment fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Payment>, Array] the matching Payment items; raises EvervaultError on failure
  ...
  # Remove an Payment matching the given criteria.
  #
  # @param reqmatch [PaymentRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payment, Hash] the removed Payment; raises EvervaultError on failure
