...
class NetworkTokenEntity
  ...
  def make
    opts = @_entopts.dup
    NetworkTokenEntity.new(@_client, opts)
  end
  ...
  # @return [NetworkToken, Hash] the current NetworkToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NetworkToken fields)
  def match_get
  ...
  #
  # @param reqmatch [NetworkTokenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NetworkToken.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NetworkToken, Hash] the loaded NetworkToken; raises EvervaultError on failure
  ...
  #
  # @param reqdata [NetworkTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [NetworkToken, Hash] the created NetworkToken; raises EvervaultError on failure
