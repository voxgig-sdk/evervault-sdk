...
class CoreEntity
  ...
  # @return [Array<Core>, Array] the matching Core items; raises EvervaultError on failure
  ...
  # Create a new Core.
  #
  # @param reqdata [CoreCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Core, Hash] the created Core; raises EvervaultError on failure
  ...
  #
  # @param reqmatch [CoreRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Core, Hash] the removed Core; raises EvervaultError on failure
