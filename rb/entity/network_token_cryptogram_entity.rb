...
class NetworkTokenCryptogramEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "network_token_cryptogram"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NetworkTokenCryptogramEntity.new(@_client, opts)
  end
  ...
  # @return [NetworkTokenCryptogram, Hash] the current NetworkTokenCryptogram data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NetworkTokenCryptogram fields)
  def match_get
  ...
  #
  # @param reqdata [NetworkTokenCryptogramCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [NetworkTokenCryptogram, Hash] the created NetworkTokenCryptogram; raises EvervaultError on failure
