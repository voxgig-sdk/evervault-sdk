...
class CardEntity
  ...
  # @return [Card, Hash] the current Card data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Card fields)
  def match_get
  ...
  # Load a single Card.
  #
  # @param reqmatch [CardLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Card.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Card, Hash] the loaded Card; raises EvervaultError on failure
  ...
  # Create a new Card.
  #
  # @param reqdata [CardCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Card, Hash] the created Card; raises EvervaultError on failure
