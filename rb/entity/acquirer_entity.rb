...
class AcquirerEntity
  ...
  def make
    opts = @_entopts.dup
    AcquirerEntity.new(@_client, opts)
  end
  ...
  # @return [Acquirer, Hash] the current Acquirer data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Acquirer fields)
  def match_get
  ...
  #
  # @param reqmatch [AcquirerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Acquirer.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Acquirer, Hash] the loaded Acquirer; raises EvervaultError on failure
  ...
  #
  # @param reqdata [AcquirerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Acquirer, Hash] the created Acquirer; raises EvervaultError on failure
  ...
  #
  # @param reqdata [AcquirerUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Acquirer, Hash] the updated Acquirer; raises EvervaultError on failure
