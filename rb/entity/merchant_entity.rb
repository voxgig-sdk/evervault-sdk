...
class MerchantEntity
  ...
  #
  # @param reqmatch [MerchantLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Merchant.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Merchant, Hash] the loaded Merchant; raises EvervaultError on failure
  ...
  #
  # @param reqdata [MerchantCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Merchant, Hash] the created Merchant; raises EvervaultError on failure
  ...
  #
  # @param reqdata [MerchantUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Merchant, Hash] the updated Merchant; raises EvervaultError on failure
