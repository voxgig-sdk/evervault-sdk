...
class CardArtEntity
  ...
  def make
    opts = @_entopts.dup
    CardArtEntity.new(@_client, opts)
  end
  ...
  # @return [CardArt, Hash] the current CardArt data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CardArt fields)
  def match_get
  ...
  #
  # @param reqmatch [CardArtLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CardArt.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CardArt, Hash] the loaded CardArt; raises EvervaultError on failure
