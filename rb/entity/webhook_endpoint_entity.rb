...
class WebhookEndpointEntity
  ...
  def make
    opts = @_entopts.dup
    WebhookEndpointEntity.new(@_client, opts)
  end
  ...
  # @return [WebhookEndpoint, Hash] the current WebhookEndpoint data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WebhookEndpoint fields)
  def match_get
  ...
  #
  # @param reqmatch [WebhookEndpointLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.WebhookEndpoint.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [WebhookEndpoint, Hash] the loaded WebhookEndpoint; raises EvervaultError on failure
  ...
  #
  # @param reqdata [WebhookEndpointUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [WebhookEndpoint, Hash] the updated WebhookEndpoint; raises EvervaultError on failure
