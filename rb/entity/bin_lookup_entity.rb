...
class BinLookupEntity
  ...
  def make
    opts = @_entopts.dup
    BinLookupEntity.new(@_client, opts)
  end
  ...
  # @return [BinLookup, Hash] the current BinLookup data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BinLookup fields)
  def match_get
  ...
  #
  # @param reqdata [BinLookupCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [BinLookup, Hash] the created BinLookup; raises EvervaultError on failure
