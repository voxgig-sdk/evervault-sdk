...
class RelayEntity
  ...
  # @return [Relay, Hash] the current Relay data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Relay fields)
  def match_get
  ...
  # Load a single Relay.
  #
  # @param reqmatch [RelayLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Relay.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Relay, Hash] the loaded Relay; raises EvervaultError on failure
  ...
  #
  # @param reqdata [RelayUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Relay, Hash] the updated Relay; raises EvervaultError on failure
