...
class ClientSideTokenEntity
  ...
  def make
    opts = @_entopts.dup
    ClientSideTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ClientSideToken, Hash] the current ClientSideToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ClientSideToken fields)
  def match_get
  ...
  #
  # @param reqdata [ClientSideTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ClientSideToken, Hash] the created ClientSideToken; raises EvervaultError on failure
